...
import 'package:owner/controller/search_controller.dart';
...
import 'package:owner/utils/place_picker_osm.dart';
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        children: [
                                                          Text(
                                                            "${Constant.amountShow(amount: double.parse(parkingModel.perHrPrice.toString()).toStringAsFixed(2))}/hr",
                                                            style: const TextStyle(
