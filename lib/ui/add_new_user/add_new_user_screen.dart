...
import 'package:owner/controller/new_user_controller.dart';
...
class AddNewUserScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<AddNewUserController>(
      init: AddNewUserController(),
      builder: (controller) {
        return Scaffold(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFieldWidget(
                            ...
                            textInputType: TextInputType.emailAddress,
                            enable: controller.userModel.value.loginType ==
                          ...
                          MobileNumberTextField(
                            ...
                            enabled: controller.userModel.value.loginType ==
  ...
  buildBottomSheet(BuildContext context, AddNewUserController controller) {
